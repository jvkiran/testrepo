...
Please note that Ocean Protocol Foundation collects your Personal Data directly from the country where you are based and stores it on servers in EU/EEA.

We may process your data outside of the EU. Regardless of where we process it, we will always conform to EU level data privacy and data protection standards. If you have questions, write to us at gdpr@oceanprotocol.com.
...
* When you participate in whitelisting, KYC and our token contribution processes. (Please note that acquirors are still subject to the [Terms & Conditions and Privacy Policy from the pre-launch](/terms-prelaunch/).)

## Creation of Personal Data

In the course of your interaction with the Ocean Protocol, we may also create Personal Data about you, such as records of your interactions with us and details of your transaction history.

## For which purposes we use your Personal Data

We use your Personal Data to provide, maintain and improve our Services, to grant you access to Ocean Protocol and enable you the use of the Ocean Protocol and the respective platform. For marketing purposes, we use your Personal Data only if and as long as we have received your explicit prior consent and in accordance with respectively applicable additional legal requirements in your jurisdiction.

## We do not sell your Personal Data to third parties.

In addition, you acknowledge that the purpose of our Service is to provide information about the Initial Project, the Whitelisting and the Initial Token Exchange. If you submit Personal Data to us for the purpose of being whitelisted for participation in the Initial Token Exchange and/or as a potential acquiror of Ocean Protocol token, you consent to our collection, processing, use and disclosure of such personal data for the purposes of such whitelisting and also the issuance, distribution, use and circulation of or exchange for Ocean Protocol Token.
...
For further information, please see [MailChimp’s Privacy Policy](https://mailchimp.com/legal/privacy/).

### Zoho Corp

To store your personal data, we are also using Zoho Corp (Zoho.eu), a service provided by our data processor Zoho Corp, located in the United States (“Zoho”) at 4141 Hacienda Drive Pleasanton, California 94588, USA. Zoho stores your personal data only in EU/EEA.

For further information, please see [Zoho’s Privacy Policy](https://www.zoho.com/privacy.html).

### Zapier Inc

To store your personal data, we are also using Zapier Inc (Zapier.com), a service provided by our data processor Zapier Inc, located in the United States (“Zapier”).

For further information, please see [Zapier’s Privacy Policy](https://zapier.com/privacy/).

### Uvionics Tech

To provide services to process data and software, we use the services of Uvionics Tech, BLK 71, Ayer Rajah Crescent #07-05, Singapore – 139951.
