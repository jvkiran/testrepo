                ...
                if (geometry instanceof THREE.BufferGeometry) {
                    ...
                    for (var v = 0, vl = vertices.length; v < vl; v++) {
                        ...
                        if (material.morphTargets === true) {
                            ...
                            for (
                                var t = 0, tl = morphTargets.length;
                                t < tl;
                                t++
                            ) {
                                ...
                                _vector3.x +=
                                    (targetVertex.x - vertex.x) * influence
                                _vector3.y +=
                                    (targetVertex.y - vertex.y) * influence
                                _vector3.z +=
                                    (targetVertex.z - vertex.z) * influence
                            }
                        }
                    ...
                    for (var f = 0, fl = faces.length; f < fl; f++) {
                        ...
                        if (
                            renderList.checkTriangleVisibility(v1, v2, v3) ===
                            false
                        )
                            continue

                        var visible = renderList.checkBackfaceCulling(
                            v1,
                            v2,
                            v3
                        )
                        ...
                        for (
                            var n = 0,
                                nl = Math.min(faceVertexNormals.length, 3);
                            n < nl;
                            n++
                        ) {
